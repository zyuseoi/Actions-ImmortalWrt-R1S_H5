...
# CONFIG_TARGET_sunxi_cortexa7 is not set
CONFIG_TARGET_sunxi_cortexa53=y
# CONFIG_TARGET_MULTI_PROFILE is not set
# CONFIG_TARGET_sunxi_cortexa53_Default is not set
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_friendlyarm_nanopi-neo-plus2 is not set
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_friendlyarm_nanopi-neo2 is not set
CONFIG_TARGET_sunxi_cortexa53_DEVICE_friendlyarm_nanopi-r1s-h5=y
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_libretech_all-h3-cc-h5 is not set
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_olimex_a64-olinuxino is not set
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_olimex_a64-olinuxino-emmc is not set
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_pine64_pine64-plus is not set
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_pine64_sopine-baseboard is not set
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_xunlong_orangepi-pc2 is not set
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_xunlong_orangepi-zero-plus is not set
CONFIG_HAS_SUBTARGETS=y
CONFIG_HAS_DEVICES=y
CONFIG_TARGET_BOARD="sunxi"
CONFIG_TARGET_SUBTARGET="cortexa53"
CONFIG_TARGET_PROFILE="DEVICE_friendlyarm_nanopi-r1s-h5"
...
# CONFIG_PACKAGE_ootoc is not set
...
# CONFIG_PACKAGE_bpytop is not set
...
# CONFIG_GOTOP_COMPRESS_GOPROXY is not set
CONFIG_GOTOP_COMPRESS_UPX=y
...
# Boot Loaders
#
CONFIG_PACKAGE_arm-trusted-firmware-sunxi=y
CONFIG_PACKAGE_u-boot-nanopi_r1s_h5=y
# end of Boot Loaders
...
# CONFIG_PACKAGE_brcmfmac-firmware-4366c0-pcie-vendor is not set
...
# CONFIG_PACKAGE_kmod-ata-sunxi is not set
...
# CONFIG_PACKAGE_kmod-fs-exfat0 is not set
...
# CONFIG_PACKAGE_kmod-rtc-sunxi is not set
...
# CONFIG_PACKAGE_kmod-mt7601u-ap is not set
...
# CONFIG_PACKAGE_kmod-rtl88x2bu is not set
...
# CONFIG_PACKAGE_node-red-contrib-web-of-things is not set
...
# CONFIG_PACKAGE_node-wot-binding-coap is not set
# CONFIG_PACKAGE_node-wot-binding-file is not set
# CONFIG_PACKAGE_node-wot-binding-http is not set
# CONFIG_PACKAGE_node-wot-binding-modbus is not set
# CONFIG_PACKAGE_node-wot-binding-mqtt is not set
# CONFIG_PACKAGE_node-wot-binding-opcua is not set
# CONFIG_PACKAGE_node-wot-binding-websockets is not set
# CONFIG_PACKAGE_node-wot-cli is not set
# CONFIG_PACKAGE_node-wot-core is not set
# CONFIG_PACKAGE_node-wot-td-tools is not set
...
# CONFIG_PACKAGE_python3-flask-restful is not set
...
# CONFIG_PACKAGE_cpp-httplib is not set
# CONFIG_PACKAGE_cxxopts is not set
...
# CONFIG_PACKAGE_jpcre2 is not set
...
# CONFIG_PACKAGE_libmicrosocks11 is not set
...
# CONFIG_PACKAGE_libtar is not set
...
# CONFIG_PACKAGE_quickjspp is not set
# CONFIG_PACKAGE_rapidjson is not set
...
# CONFIG_PACKAGE_luci-app-brook is not set
...
# CONFIG_PACKAGE_luci-theme-netgearv2 is not set
...
# CONFIG_PACKAGE_simple-torrent is not set
# CONFIG_SIMPLE_TORRENT_COMPRESS_GOPROXY is not set
CONFIG_SIMPLE_TORRENT_COMPRESS_UPX=y
...
# CONFIG_GOWEBDAV_COMPRESS_GOPROXY is not set
...
CONFIG_WEBDAV_GO_COMPRESS_UPX=y
...
# CONFIG_PACKAGE_iptvhelper is not set
...
# CONFIG_PACKAGE_gq-client is not set
CONFIG_GQ_CLIENT_COMPRESS_UPX=y
# CONFIG_PACKAGE_gq-server is not set
CONFIG_GQ_SERVER_COMPRESS_UPX=y
...
# CONFIG_CDNSPEEDTEST_COMPRESS_GOPROXY is not set
CONFIG_CDNSPEEDTEST_COMPRESS_UPX=y
...
# CONFIG_PACKAGE_fcgiwrap is not set
...
# CONFIG_GO_NATS_COMPRESS_GOPROXY is not set
CONFIG_GO_NATS_COMPRESS_UPX=y
...
# CONFIG_PACKAGE_microsocks11 is not set
...
# CONFIG_PACKAGE_subweb is not set
...
# CONFIG_PACKAGE_avro-c-utils is not set
...
# CONFIG_FILEBROWSER_COMPRESS_GOPROXY is not set
CONFIG_FILEBROWSER_COMPRESS_UPX=y
...
# CONFIG_PACKAGE_homeassistant is not set
...
# CONFIG_SYNCTHING_COMPRESS_GOPROXY is not set
CONFIG_SYNCTHING_COMPRESS_UPX=y
...
# CONFIG_PACKAGE_thefuck is not set
...
# CONFIG_YQ_COMPRESS_GOPROXY is not set
CONFIG_YQ_COMPRESS_UPX=y
EOF
